        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6">
                            <strong>Update Category</strong><small> Form</small>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="card-body card-block">
                    ...
                    <form id="updateCategory" action="{{route('update.category',$category->id)}}" method="POST">
                        @csrf
                        <div class="form-group">
                            <div class="row no-gutters">
                                ...
                                <div class="col-md-10">
                                    <input type="text" value="{{$category->name}}"  id="name" placeholder="Name" name="name" class="form-control form-control-sm">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row no-gutters">
                                ...
                                <div class="col-md-10">
                                    <select name="parent_category_id" class="form-control form-control-sm" id="parent_category_id">
                                        ...
                                        @foreach ($mainCategory as $Pcategroy)
                                        <option {{$category->parent_category_id == $Pcategroy->id ? 'SELECTED' : ''}} value="{{$Pcategroy->id}}">{{$Pcategroy->name}}</option>
                                        @endforeach 
                                    </select>
                                </div> 
                            </div> 

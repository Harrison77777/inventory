                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="btn btn-info btn-sm btn-s" href="{{route('current.month.all.sale')}}">Back</a></li>
                        </ol>
                    </div>
                </div> 
            </div>           
    ...
    <div class="content">
        <div class="col-md-12 col-lg-12">
            <div class="animated fadeIn">
              ...
              <a class="text-dark" href="{{route('current.month.particular.customer.buy.details',$customer->id)}}">
              <div class="col-md-12">
                    <div class="row">

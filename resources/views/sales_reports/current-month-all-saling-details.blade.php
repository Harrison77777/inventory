 ...
 <div id="right-panel" class="right-panel">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a class="activate" href="#"> <strong> All Selling Details of Current Month {{(date('F'))}} </strong>(Date Wise)</a></li>
        </ol>
    </nav>
                ...
                <div class="page-title">
                   <div class="row">
                       <div class="col-md-5 col-lg-7">
                            <h1>All Selling Details of Current Month {{(date('F'))}}</h1>
                       </div>
        ...
        <div class="col-md-12 col-lg-12">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            @foreach ($currentMonthAllSalesDate as $date)
                            <div class="col-md-2 mr-2">
                                <a class="btn btn-success btn-sm" href="{{route('current.month.datewise.all.buyer.customer',$date->date)}}">Sales Details of <span class="text-color"><strong> {{$date->date}}</strong></span> </a>
                            </div> 
                            @endforeach
                        </div>
                    </div>
